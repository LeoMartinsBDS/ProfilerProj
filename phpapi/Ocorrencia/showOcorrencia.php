...
function showOcorrencia($cod_status, $cod_tipo)
{
	...
	SELECT OCO.COD_OCORRENCIA, OCO.DESCRICAO, OCO.FOTO, 
GROUP BY(OCO.COD_OCORRENCIA)
	
	$query = " SELECT OCO.DESCRICAO AS DESCRICAO_OCORRENCIA, OCO.DATA_HORA, OCO.FOTO, OCO.LOCALIDADE, S.DESCRICAO AS DESCRICAO_STATUS,
